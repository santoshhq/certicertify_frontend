...
const NAV_ITEMS: {
  ...
  { to: "/admin/students", label: "Student Records", icon: Users, permission: "students_view" },
  { to: "/admin/students/upload", label: "Add Student Records", icon: UploadCloud, permission: "students_create" },
];
  ...
  return (
    <div className="min-h-svh bg-paper lg:grid lg:grid-cols-[268px_1fr]">
      <aside className="hidden flex-col bg-pine-950 py-6 lg:sticky lg:top-0 lg:flex lg:h-svh lg:overflow-y-auto">
        ...
        <div className="mb-4 flex items-center gap-2 px-5 text-amber-600">
          <ShieldCheck size={14} />
