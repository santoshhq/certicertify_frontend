...
import { uploadStudents } from "../lib/students";
  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className="mt-2 max-w-xl text-sm text-ink-400">
        Upload an .xlsx roster with your students, and optionally attach
        certificates — PDF or JPG files named after each roll number (e.g.
        "ABC101.pdf" matches roll number ABC101), or a single .zip archive
        containing all of them. Zips are unpacked on the server automatically.
      </p>
