...
import {
  ...
  listStudentsByInstitutionAsAdmin,
  updateStudentAsAdmin,
  deleteStudentAsAdmin,
  uploadStudentsAsAdmin,
  replaceStudentCertificateAsAdmin,
} from "../lib/admin";
...
export default function AdminStudentsPage() {
  ...
  const certificate = useCertificateReplace(setStudents, replaceStudentCertificateAsAdmin);
  ...
  async function load(institutionName: string) {
    ...
    setError(null);
    try {
      setStudents(await listStudentsByInstitutionAsAdmin(institutionName));
    } catch (err) {
